...
assert(fs.existsSync(manifest.action.default_popup));
...
for (const file of ["src/counting.js", "src/peer-counting.js", "src/rtp-stats.js", "src/main-world.js", "src/content-bridge.js", "src/service-worker.js", "popup.js", "demo.js"]) {
...
console.log("Manifest, popup action, JavaScript syntax, permissions and binary-free assets are valid.");
